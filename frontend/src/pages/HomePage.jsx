        ...
        <>
            ...
            <section className="bg-[var(--color-secondary)] w-full py-12 flex flex-row justify-center items-center gap-4">
                ...
                <div className="flex flex-col justify-start gap-2">
                    ...
                    <button className="bg-[var(--color-primary)] cursor-pointer hover:bg-[var(--color-secondary)] hover:text-[var(--color-primary)] text-[var(--color-secondary)] font-redwing px-4 py-2 rounded-lg text-lg mt-4">
                        LEARN MORE
                    </button>
